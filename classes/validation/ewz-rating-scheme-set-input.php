...
/* Validation for the forms on the Rating Schemes page */

class Ewz_Rating_Scheme_Set_Input extends Ewz_Input
{
     ...
     function __construct( $form_data ) {
         ...
         $this->rules = array(
                  ...
                  'ewzmode'        =>  array( 'type' => 'fixed',      'req' => true,  'val' => 'sc_set' ),
                  'action'         => array( 'type' => 'fixed',       'req' => true, 'val' => 'ewz_save_scheme_order' ),
                  'ewznonce'       =>  array( 'type' => 'anonce',     'req' => true,  'val' => '' ),
                  'scorder'        =>  array( 'type' => 'v_order',   'req' => true,  'val' => '' ),
                  );
        $this->validate();
     }
    ...
    function v_order( $value, $arg ) {
        ...
        if ( is_array( $value ) ) {
            ...
            throw new EWZ_Exception( "Bad input data for rating scheme order" );
        }
        return true;
     }
}
